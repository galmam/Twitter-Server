...
public class User {
	...
	public boolean CompareTo(String other){
		if (other.equals("gal3")) System.out.println(this.Name+"?=?"+other+" / the answer is "+this.Name.equals(other));
    ...
    public synchronized boolean  startFollowingUser(User user,int ID){
    	this.LOGGER.warning("is the user "+this.Name+" following the user "+user.getName()+"? "+this.Tweeter.isFollowing(user));
