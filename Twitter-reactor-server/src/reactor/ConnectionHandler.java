...
public class ConnectionHandler<T> {
	...
	public void shoutDownServer(){
		this._data.serverShoutDown();
		logger.warning("ShoutDown command was given from the user "+this.User.getName());
	}
    ...
    public  synchronized void writeToClient(String msg) {
    	...
    	addOutData(ByteBuffer.wrap(msg.getBytes(charset)));
    }
    
	// this is the method we guess is writing
	...
	/**
	 * switches the handler to read / write  catch blockmode
	 * 
	 * @throws ClosedChannelException
    ...
    public String getStatistics(){
    	String s=this._data.getStatistics();
    	logger.info(s);
    	return s;
    }
    ...
    public String onlineUsers(){
    	String s=this._data.onlineUsers();
    	logger.info(s);
    	return s;
    }
    ...
    public String usersList(){
    	String s=this._data.getUsersLists();
    	logger.info(s);
    	return s;
    }
    ...
    public User addNewUser(String Name,String Password){
    	this.User=this._data.addNewUser(Name, Password);
    	return this.User;
    }
    ...
    public User isRegistered(String name){
    	return this._data.isRegistered(name);
    }
