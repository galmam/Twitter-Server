...
public class StompFrameFactory {
	...
	public  static StompFrame Create(String Command){
	        ...
	        catch (InstantiationException e) {System.out.println("strange");} 
	        catch (IllegalAccessException e) {System.out.println("strange");}
	        catch (ClassNotFoundException e) {object=new ERROR("The frame send was malformed","");object.Complete();System.out.println("wrong message format");}
